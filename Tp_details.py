...
def addition():
    df=pd.read_csv(r'C:\Users\User\Desktop\tp_details.csv',encoding=
    'unicode_escape')
    ...
    if c=='yes':
        ...
        df1=pd.DataFrame([[cust_id,pkp,pkpt,price]],columns=["cust_id","pickup_date","pickup_time","price_in_dhs"])
        df2=df.append(df1)

        #write the new dataframe to the csv file
        #read it back from the csv file
        #and display it to the user
        df2=df2.to_csv(r'C:\Users\User\Desktop\tp_details.csv',index=False,header=True)
        df=pd.read_csv(r'C:\Users\User\Desktop\tp_details.csv',encoding='unicode_escape')
        print("\ntable updated\n",df)
...
def deletion():
    ...
    df=pd.read_csv (r'C:\Users\User\Desktop\tp_details.csv')
    print("\nThis is the existing table:")
    print(df)
    ...
    df.to_csv(r'C:\Users\User\Desktop\tp_details.csv',
...
def modify():
    ...
    print("Row modified!!!\n",df)
    df.to_csv(r'C:\Users\User\Desktop\tp_details.csv', index=False,
    header=True)
